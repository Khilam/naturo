        ...
        <Row>
          <Col md={4} xs={12}>
            <div className="">
              ...
              <p className="">
                Ces consultations ne remplacent pas une consultation médicale.
                Ce sont des bilans de vitalité qui permettent d’évaluer votre
                état de santé global et votre niveau d’énergie. Lors de la
                consultation nous mettrons en place un programme d’hygiène de
                vie qui sera votre feuille de route au quotidien. Le but de ces
                consultations est de vous apporter une réponse globale à vos
                problématiques physiques et émotionnelles, à travers des
                conseils d’hygiène de vie, qui se basent uniquement sur des
                techniques exclusivement naturelles : alimentation, exercice
                physique, gestion des émotions, phytologie, huiles essentielles,
                hydrologie, etc{" "}
              </p>
            </div>
          </Col>
          <Col md={4} xs={12}>
            <div>
              <img className="" src={treemen} alt="treemen" />
            </div>
          </Col>
          <Col md={4} xs={12}>
            <div className="">
              ...
              <p className="">
                Le naturopathe est un éducateur de santé. Il établit un bilan de
                vitalité personnalisé et vous permet de mieux vous connaître.
                Vous prendrez conscience de vos forces et de vos faiblesses, de
                votre niveau d’énergie vitale. Vous repartirez avec une
                meilleure connaissance de votre organisme. Ensemble, vous
                établirez un programme qui vous permettra d’optimiser votre
                forme : alimentation, habitudes de vie à mettre en place,
                conseils phytothérapie et aromathérapie. Le rôle du naturopathe
                est ainsi de vous rendre le plus informé possible et le plus
                autonome vis-à-vis de votre santé.
              </p>
            </div>
          </Col>
        </Row>
