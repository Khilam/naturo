								...
								<div className="card-back">
								  <div className="center-wrap">
									<div className="section text-center">
									  ...
									  <div className="form-group">
										<input type="text" name="loglastname" className="form-style" placeholder="Your Lastname" id="loglastname" autoComplete="off" onChange={(e) => setLastname(e.target.value)}/>
										<i className="input-icon uil uil-user" />
									  </div>
									  <div className="form-group">
									  ...
									  <div className="form-group">
										<input type="text" name="logadresse" className="form-style" placeholder="Your Adress" id="logadresse" autoComplete="off" onChange={(e) => setAdresse(e.target.value)}/>
										<i className="input-icon uil uil-user" />
									  </div>	
									  <div className="form-group mt-2">
										<input type="email" name="logemail" className="form-style" placeholder="Your Email" id="logemail" autoComplete="off" onChange={(e) => setEmail(e.target.value)}/>
