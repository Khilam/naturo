...
import React, { useState, useEffect } from 'react'
// import styles from "./Cart.module.css";
import { removeFromCart, saveOrder, adjustItemQty } from '../../Redux/Action/orderAction'
import { connect, useSelector, useDispatch } from 'react-redux'
import Navbar from '../../Shared/navbar'
import RemoveIcon from '@material-ui/icons/Remove'
import DeleteIcon from '@material-ui/icons/Delete'
      ...
      <div class="container">
        ...
        <ul class="responsive-table">
              ...
              <tr key={item.id}>
                ...
                <div className="table-row">
                  ...
                  <td className="col col-4">
                    {/* <button onClick={() => increment(item, item.qty +1)}/>{qty}
                    <RemoveIcon onClick={() => decrement( item, item.qty- 1)}/> */}
                  </td>
                  <input onClick 
            min="1"
            type="number"
          ...
          />
                  ...
                  <td className="col col-1">{item.price* item.qnty}
          </td>
